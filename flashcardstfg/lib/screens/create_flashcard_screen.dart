...
class _CreateFlashcardScreen extends State<CreateFlashcardScreen> {
          ...
          children: [
            ...
            SegmentedButton<MetodoEntrada>(
              ...
              if (_metodoSeleccionado == MetodoEntrada.texto)
                ...
                _crearBotonSubida(Icons.camera_alt, 'Tomar Foto o Subir Imagen')
              else if (_metodoSeleccionado == MetodoEntrada.archivo)
                _crearBotonSubida(Icons.picture_as_pdf, 'Subir PDF o Documento'),
  ...
  Widget _crearBotonSubida(IconData icono, String texto) {
    return Container(
      height: 150,
